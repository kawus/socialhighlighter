...
- `Hero.tsx` - "Early access" badge, **Veo camera badge** ("Works with Veo Cam & Veo Go"), dual CTAs (primary: "See How It Works", secondary: "Join the Waitlist"), **clickable video placeholder** (→ `/try` with hover effects)
